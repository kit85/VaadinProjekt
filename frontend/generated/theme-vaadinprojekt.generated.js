...
import stylesCss from 'themes/vaadinprojekt/styles.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_vaadinprojekt_componentCss']) {
    
    document['_vaadintheme_vaadinprojekt_componentCss'] = true;
  }
